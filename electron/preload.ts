...
const api: SpaceAssistantApi = {
  ...
  chatGetPendingConfirmation: (payload) => ipcRenderer.invoke('chat:get-pending-confirmation', payload),
  ...
  fileExportMarkdown: (payload) => ipcRenderer.invoke('file:export-markdown', payload),
