...
const MATRIX: MatrixCase[] = [
  ...
  { name: 'redirection', bash: 'echo ok > ./out.txt', powershell: 'Write-Output ok > .\out.txt', expectedCompleteness: 'complete', expectedCompletenessPs: 'partial', expectedConnectors: [] },
  ...
  { name: 'command substitution', bash: 'echo $(date)', powershell: 'Write-Output $(Get-Date)', expectedCompleteness: 'complete', expectedCompletenessPs: 'partial', expectedConnectors: [] },
