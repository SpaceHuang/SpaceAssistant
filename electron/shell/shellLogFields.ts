...
const ALLOWED_KEYS = new Set([
  ...
  'outputArtifactReason', 'rawArtifactPath', 'rawArtifactBytes', 'rawArtifactSha256', 'rawArtifactReason',
  'stdoutEncoding', 'stderrEncoding', 'encodingSource', 'encodingConfidence', 'contractKind', 'contractConflict',
  'lossStage', 'outputTrust', 'outputDiag', 'decodeReplacements',
  ...
  // P0-D3 组 1/组 5（§5.4.3）：run_script 执行期事件字段与 env 快照（键计数 + 哈希，值永不落盘）
  'interpreter', 'envKeyCount', 'envKeysSha256', 'envEntriesSha256'
])
